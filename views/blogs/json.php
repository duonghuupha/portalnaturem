...
<table 
    ...
    <thead>
        <tr role="row">
            ...
            <th class="" style="width:300px">Tiêu đề</th>
            <th class="text-left">Nội dung ngắn</th>
...
<div class="row mini">
    ...
    <div class="col-xs-12 col-sm-6">
        ...
        if($jsonObj['total'] > $perpage){
            ...
            $createlink = $this->_Convert->createLinks($jsonObj['total'], $perpage, $pagination['number'], 'view_page_blog', 1);
        ?>
