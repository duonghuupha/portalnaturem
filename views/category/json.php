...
<table 
    ...
    <thead>
        <tr role="row">
            ...
            <th class="text-center" style="width:120px">Mã danh mục</th>
    ...
    <tbody>
        ...
        <tr role="row" class="<?php echo $class ?>">
            ...
            <td class="text-left">
                <span style="display:inline-block;height:38px;overflow:hidden">
            ...
            <td class="hidden" id="desc_<?php echo $row['id'] ?>"><?php echo $row['description'] ?></td>
        </tr>
        <?php
        }
        ?>
...
<div class="row mini">
    ...
    <div class="col-xs-12 col-sm-6">
        ...
        if($jsonObj['total'] > $perpage){
            ...
            $createlink = $this->_Convert->createLinks($jsonObj['total'], $perpage, $pagination['number'], 'view_page_category', 1);
        ?>
